...
; (function(a) {
    a.fn.camera = function(b, c) {
        function bi(c) {
            ...
            if (w[l] != "") {
                a(".camera_target_content .cameraContent:eq(" + l + ")", f).append('<a class="camera_link" href="' + w[l] + '" target="' + x[l] + '"></a>')
            }
            ...
            if (!a(".imgLoaded", m).length) {
                ...
                E = 1,
                F = 0,
                G, H, I, M, N, O = new Array("simpleFade", "curtainTopLeft", "curtainTopRight", "curtainBottomLeft", "curtainBottomRight", "curtainSliceLeft", "curtainSliceRight", "blindCurtainTopLeft", "blindCurtainTopRight", "blindCurtainBottomLeft", "blindCurtainBottomRight", "blindCurtainSliceBottom", "blindCurtainSliceTop", "stampede", "mosaic", "mosaicReverse", "mosaicRandom", "mosaicSpiral", "mosaicSpiralReverse", "topLeftBottomRight", "bottomRightTopLeft", "bottomLeftTopRight", "topRightBottomLeft", "scrollLeft", "scrollRight", "scrollTop", "scrollBottom", "scrollHorz");
                marginLeft = 0,
                marginTop = 0,
                opacityOnGrid = 0;
                ...
                var P = a(" > div", j).eq(l).attr("data-fx");
                if (e() && b.mobileFx != "" && b.mobileFx != "default") {
                    M = b.mobileFx
                } else {
                    if (typeof P !== "undefined" && P !== false && P !== "default") {
                        M = P
                    } else {
                        M = b.fx
                    }
                ...
                G = a(" > div", j).eq(l).attr("data-slideOn");
                if (typeof G !== "undefined" && G !== false) {
                    S = G
                } else {
                    if (b.slideOn == "random") {
                        var S = new Array("next", "prev");
                        S = W(S);
                        S = S[0]
                    } else {
                        S = b.slideOn
                ...
                var X = a(" > div", j).eq(l).attr("data-time");
                if (typeof X !== "undefined" && X !== false && X !== "") {
                    H = parseFloat(X)
                } else {
                    H = b.time
                }
                var Y = a(" > div", j).eq(l).attr("data-transPeriod");
                ...
                var Z = 0;
                var _ = A * C;
                var bd = t - Math.floor(t / C) * C;
                var be = u - Math.floor(u / A) * A;
                var bf;
                var bj;
                var bk = 0;
                var bl = 0;
                ...
                while (Z < _) {
                    bm.push(Z);
                    bn.push(Z);
                    D.append('<div class="cameraappended" style="display:none; overflow:hidden; position:absolute; z-index:1000" />');
                    var bp = a(".cameraappended:eq(" + Z + ")", k);
                    if (M == "scrollLeft" || M == "scrollRight" || M == "scrollTop" || M == "scrollBottom" || M == "scrollHorz") {
                        R.eq(l).clone().show().appendTo(bp)
                    } else {
                        if (S == "next") {
                            R.eq(l).clone().show().appendTo(bp)
                        } else {
                            R.eq(d).clone().show().appendTo(bp)
                        }
                    }
                    if (Z % C < bd) {
                        bf = 1
                    ...
                    if (Math.floor(Z / C) < be) {
                        bj = 1
                    } else {
                        bj = 0
                    }
                    bp.css({
                        height: Math.floor(u / A + bj + 1),
                        left: bk,
                        top: bl,
                        width: Math.floor(t / C + bf + 1)
                    });
                    a("> .cameraSlide", bp).css({
                        height: u,
                        "margin-left": "-" + bk + "px",
                        "margin-top": "-" + bl + "px",
                        width: t
                ...
                case "mosaicSpiral":
                    ...
                    for (bt = 0; bt < bq; bt++) {
                        bs = bt;
                        for (br = bt; br < C - bt - 1; br++) {
                            bo[bu++] = bs * C + br
                        }
                        br = C - bt - 1;
                        for (bs = bt; bs < A - bt - 1; bs++) {
                            bo[bu++] = bs * C + br
                        }
                        bs = A - bt - 1;
                        for (br = C - bt - 1; br > bt; br--) {
                            bo[bu++] = bs * C + br
                        }
                        br = bt;
                        for (bs = A - bt - 1; bs > bt; bs--) {
                            bo[bu++] = bs * C + br
                        }
                    }
                    bm = bo;
                ...
                case "mosaicSpiralReverse":
                    ...
                    break;
                case "topLeftBottomRight":
                    for (var bs = 0; bs < A; bs++) for (var br = 0; br < C; br++) {
                        bo.push(br + bs)
                    }
                    bn = bo;
                    break;
                case "bottomRightTopLeft":
                    ...
                    break;
                case "bottomLeftTopRight":
                    for (var bs = A; bs > 0; bs--) for (var br = 0; br < C; br++) {
                        bo.push(br + bs)
                    }
                    bn = bo;
                    break;
                case "topRightBottomLeft":
                    for (var bs = 0; bs < A; bs++) for (var br = C; br > 0; br--) {
                        bo.push(br + bs)
                    }
                    bn = bo;
                    break
                ...
                function(c, e) {
                    function o() {
                        ...
                        if (a(".cameraeased", k).length == _) {
                            ...
                            R.eq(l).show().css("z-index", "999").addClass("cameracurrent");
                            R.eq(d).css("z-index", "1").removeClass("cameracurrent");
                            ...
                            var c = R.eq(l).find(".fadeIn").length;
                            ...
                            if (c != 0) {
                                a(".cameraSlide.cameracurrent .fadeIn", g).each(function() {
                                    ...
                                    if (j.indexOf("fadeIn") != -1) {
                                        ...
                                        0).css("visibility", "visible").delay(H / c * .1 * (k - 1)).animate({
                                            opacity: 1
                                        },
                                        H / c * .15, b)
                                    } else {
                            ...
                            if (e != 0) {
                                a(".cameraContent.cameracurrent .moveFromLeft, .cameraContent.cameracurrent .moveFromRight, .cameraContent.cameracurrent .moveFromTop, .cameraContent.cameracurrent .moveFromBottom, .cameraContent.cameracurrent .fadeIn, .cameraContent.cameracurrent .fadeFromLeft, .cameraContent.cameracurrent .fadeFromRight, .cameraContent.cameracurrent .fadeFromTop, .cameraContent.cameracurrent .fadeFromBottom", g).each(function() {
                                    ...
                                    if (h.indexOf("moveFromLeft") != -1) {
                                        ...
                                        c.css("visibility", "visible").delay(H / e * .1 * (i - 1)).animate({
                                            left: d.left
                                        },
                                        H / e * .15, b)
                                        ...
                                        0).css("visibility", "visible").delay(H / e * .1 * (i - 1)).animate({
                                            opacity: 1
                                        },
                                        H / e * .15, b)
                                    } else {
                            ...
                            K = setInterval(function() {
                                if (h != "pie") {
                                    if (ba <= 1.002 && !j.hasClass("stopped") && !j.hasClass("paused")) {
                                        ba = ba + .005
                                    } else if (ba <= 1 && (j.hasClass("stopped") || j.hasClass("paused"))) {
                                        ba = ba
                                    } else {
                                    ...
                                    case "leftToRight":
                                        a("#" + i).css({
                                            right: a(".camera_bar_cont", U).width() - a(".camera_bar_cont", U).width() * ba
                                        });
                                        break;
                                    case "rightToLeft":
                                        a("#" + i).css({
                                            left: a(".camera_bar_cont", U).width() - a(".camera_bar_cont", U).width() * ba
                                        });
                                        break;
                                    case "topToBottom":
                                        a("#" + i).css({
                                            bottom: a(".camera_bar_cont", U).height() - a(".camera_bar_cont", U).height() * ba
                                        });
                                        break;
                                    case "bottomToTop":
                                        a("#" + i).css({
                                            top: a(".camera_bar_cont", U).height() - a(".camera_bar_cont", U).height() * ba
                                        });
                                        break
                                    }
                                } else {
                                    bb = ba;
                                    bc.clearRect(0, 0, b.pieDiameter, b.pieDiameter);
                                    bc.globalCompositeOperation = "destination-over";
                                    bc.beginPath();
                                    bc.arc(b.pieDiameter / 2, b.pieDiameter / 2, b.pieDiameter / 2 - b.loaderStroke, 0, Math.PI * 2, false);
                                    bc.lineWidth = b.loaderStroke;
                                    bc.strokeStyle = b.loaderBgColor;
                                    bc.stroke();
                                    bc.closePath();
                                    bc.globalCompositeOperation = "source-over";
                                    bc.beginPath();
                                    bc.arc(b.pieDiameter / 2, b.pieDiameter / 2, b.pieDiameter / 2 - b.loaderStroke, 0, Math.PI * 2 * bb, false);
                                    bc.lineWidth = b.loaderStroke - b.loaderPadding * 2;
                                    bc.strokeStyle = b.loaderColor;
                                    bc.stroke();
                                    bc.closePath();
                                    if (ba <= 1.002 && !j.hasClass("stopped") && !j.hasClass("paused")) {
                                        ba = ba + .005
                                        ...
                                        if (!j.hasClass("stopped") && !j.hasClass("paused")) {
                                            clearInterval(K);
                                            V();
                                            a("#" + i + ", .camera_canvas_wrap", U).animate({
                                                opacity: 0
                                            },
                                            200,
                                            function() {
                    ...
                    case "stampede":
                        height = 0;
                        width = 0;
                        marginLeft = t * .2 * (c % C - (C - Math.floor(C / 2))) + "px";
                        marginTop = u * .2 * (Math.floor(c / C) + 1 - (A - Math.floor(A / 2))) + "px";
                        break;
                    case "mosaic":
                        height = 0;
                        width = 0;
                    ...
                    case "mosaicRandom":
                        height = 0;
                        width = 0;
                        marginLeft = Math.floor(t / C + bf + 1) * .5 + "px";
                        marginTop = Math.floor(u / A + bj + 1) * .5 + "px";
                        break;
                    case "mosaicSpiral":
                        height = 0;
                        width = 0;
                    ...
                    var n = parseFloat(I) + parseFloat(F);
                    if (M == "scrollLeft" || M == "scrollRight" || M == "scrollTop" || M == "scrollBottom" || M == "scrollHorz") {
                        n = 0;
                        m.delay((I + F) / _ * bn[c] * E * .5).css({
                            display: "block",
                            height: height,
                        ...
                        I - F, N, o);
                        R.eq(d).delay((I + F) / _ * bn[c] * E * .5).animate({
        ...
        function bg() {
            if (a(s).length && !a(r).length) {
                ...
                bf = false;
                a(".camera_prevThumbs", U).css("visibility", "visible");
                a(".camera_nextThumbs", U).css("visibility", "visible");
                var j = d.left,
        ...
        var D = a(".cameraCont", f);
        var E;
        for (E = 0; E < B; E++) {
            D.append('<div class="cameraSlide cameraSlide_' + E + '" />');
            var F = a("> div:eq(" + E + ")", j);
            k.find(".cameraSlide_" + E).clone(F)
        }
        ...
        if (j.length != 0) {
            var R = a(".cameraSlide", k);
            R.wrapInner('<div class="camerarelative" />');
            var S;
            var T = b.barDirection;
            var U = f;
        ...
        if (h != "pie") {
            ...
            Y.setAttribute("width", b.pieDiameter);
            Y.setAttribute("height", b.pieDiameter);
            var _;
            ...
            Y.setAttribute("style", "position:absolute; z-index:1002; " + _);
            var ba;
            var bb;
            if (Y && Y.getContext) {
                var bc = Y.getContext("2d");
                bc.rotate(Math.PI * (3 / 2));
                bc.translate( - b.pieDiameter, 0)
            }
        }
        if (h == "none" || N == false) {
            a("#" + i).hide();
        ...
        if (a(r).length) {
            ...
            var bd;
            for (bd = 0; bd < B; bd++) {
                a(".camera_pag_ul", f).append('<li class="pag_nav_' + bd + '" style="position:relative; z-index:1002"><span><span>' + bd + "</span></span></li>")
            }
    ...
    a.fn.cameraStop = function() {
        ...
        if (a(".camera_stop", e).length) {
            a(".camera_stop", e).hide();
            a(".camera_play", e).show();
            if (a("#" + d).length) {
                a("#" + d).hide()
            }
        } else {
    ...
    a.fn.cameraPlay = function() {
        var b = a(this),
        c = a(".camera_src", b),
        d = "pie_" + b.index();
        c.removeClass("stopped");
        if (a(".camera_showcommands").length) {
            var e = a(".camera_thumbs_wrap", b)
        } else {
            var e = b
        }
        if (a(".camera_play", e).length) {
            a(".camera_play", e).hide();
            a(".camera_stop", e).show();
            if (a("#" + d).length) {
                a("#" + d).show()
            }
        } else {
